@echo off
REM Batch script to compile and run weapon system property-based tests
REM Requires Visual Studio 2022 or MinGW to be installed

echo ========================================
echo Weapon System Test Compiler
echo ========================================
echo.
...
if defined VSINSTALLDIR (
    ...
    if %ERRORLEVEL% EQU 0 (
        ...
        g++ -std=c++17 run_weapon_tests.cpp -o run_weapon_tests.exe
