...
## Замедление пуль через деревянные стены

**✅ РЕАЛИЗОВАНО (v1.1):**
- Пули теряют 50% скорости при прохождении через деревянную стену
- Дальность также уменьшается на 50%
- Множественные стены: эффект накапливается (50% → 25% → 12.5%)

**Подробности:** См. `WOOD_PENETRATION_SLOWDOWN.md`
...
- Разные типы дерева с разной степенью замедления
