...
**Пользовательская история:** Как игрок (сервер или клиент), я хочу ограниченную видимость вокруг моего персонажа с туманом войны, чтобы игра имела стратегическую глубину и элементы исследования.

#### Критерии приёмки

1. КОГДА отрисовывается игровой вид на сервере или клиенте, ТОГДА система ДОЛЖНА отображать радиус видимости 25 единиц вокруг персонажа игрока
...
7. КОГДА отрисовывается игрок сервера на сервере, ТОГДА система ДОЛЖНА применять туман войны относительно позиции зелёного круга (игрока сервера)
8. КОГДА отрисовывается игрок клиента на клиенте, ТОГДА система ДОЛЖНА применять туман войны относительно позиции синего круга (игрока клиента)
